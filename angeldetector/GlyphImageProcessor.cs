            ...
            lock (sync)
            {
                ...
                if (glyphs.Count > 0)
                {
                         ...
                         (visualizationType == VisualizationType.Name))
                    {
                        ...
                        {
                            //var a0 = Math.Pow( glyphData.RecognizedQuadrilateral[0].X - glyphData.RecognizedQuadrilateral[1].X,2);
                            //var b0 = Math.Pow( glyphData.RecognizedQuadrilateral[0].Y - glyphData.RecognizedQuadrilateral[1].Y,2);
                            //var a1 = Math.Pow( glyphData.RecognizedQuadrilateral[1].X - glyphData.RecognizedQuadrilateral[2].X,2);
                            //var b1 = Math.Pow( glyphData.RecognizedQuadrilateral[1].Y - glyphData.RecognizedQuadrilateral[2].Y,2);
                            //var a2 = Math.Pow( glyphData.RecognizedQuadrilateral[2].X - glyphData.RecognizedQuadrilateral[3].X,2);
                            //var b2 = Math.Pow( glyphData.RecognizedQuadrilateral[2].Y - glyphData.RecognizedQuadrilateral[3].Y,2);
                            //var a3 = Math.Pow( glyphData.RecognizedQuadrilateral[3].X - glyphData.RecognizedQuadrilateral[0].X,2);
                            //var b3 = Math.Pow(glyphData.RecognizedQuadrilateral[3].Y - glyphData.RecognizedQuadrilateral[0].Y ,2);
                            //var s0 = Math.Sqrt(a0 + b0);
                            //var s1 = Math.Sqrt(a1 + b1);
                            //var s2 = Math.Sqrt(a2 + b2);
                            //var s3 = Math.Sqrt(a3 + b3);
